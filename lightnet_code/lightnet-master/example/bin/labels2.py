...
if __name__ == '__main__':
    ...
    for (year, img_set) in TRAINSET:
        with open(f'/Users/sai/Downloads/lightnet-master/{args.root}/VOCdevkit/VOC{year}/ImageSets/Main/{img_set}.txt', 'r') as f:
            ids = f.read().strip().split()
        train += [f'/Users/sai/Downloads/lightnet-master/{args.root}/VOCdevkit/VOC{year}/Annotations/{xml_id}.xml' for xml_id in ids]
    ...
    bb.io.save(train_annos, 'pandas', f'/Users/sai/Downloads/lightnet-master/{args.root}/train{args.extension}')
    ...
    for (year, img_set) in TESTSET:
        with open(f'/Users/sai/Downloads/lightnet-master/{args.root}/VOCdevkit/VOC{year}/ImageSets/Main/{img_set}.txt', 'r') as f:
            ids = f.read().strip().split()
        test += [f'/Users/sai/Downloads/lightnet-master/{args.root}/VOCdevkit/VOC{year}/Annotations/{xml_id}.xml' for xml_id in ids]
    ...
    bb.io.save(test_annos, 'pandas', f'/Users/sai/Downloads/lightnet-master/{args.root}/test{args.extension}')
